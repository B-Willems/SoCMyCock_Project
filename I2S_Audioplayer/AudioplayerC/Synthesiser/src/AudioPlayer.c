...
void AudioPlayer_SendTestSignal(u32 Cycles,short int type, char octave,char note )
{
	...
	if(type ==1){ AudioPlayer_ChangeFreq(9-note,3-octave); AudioPlayer_CopyBuffer(_TestSignal);}
	if(type ==2){ AudioPlayer_ChangeFreq(9-note,3-octave);	AudioPlayer_CopyBuffer(_SquareTest);}
	if(type ==3){ AudioPlayer_ChangeFreq(9-note,3-octave);	AudioPlayer_CopyBuffer(_TriangleTest);}
	if(type ==4){ AudioPlayer_ChangeFreq(9-note,3-octave);	AudioPlayer_CopyBuffer(_SpecialTest);}
	//AudioPlayer_CopyBuffer();
}
