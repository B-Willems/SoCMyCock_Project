...
# module references:
# vhdl_clockdivider_by_8, vhdl_clockdivider_by_64
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {22.580647} \
  ...
  # Create instance: vhdl_clockdivider_by_0, and set properties
  set block_name vhdl_clockdivider_by_8
  set block_cell_name vhdl_clockdivider_by_0
  if { [catch {set vhdl_clockdivider_by_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $vhdl_clockdivider_by_0 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: vhdl_clockdivider_by_1, and set properties
  set block_name vhdl_clockdivider_by_64
  set block_cell_name vhdl_clockdivider_by_1
  if { [catch {set vhdl_clockdivider_by_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $vhdl_clockdivider_by_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
