...
HD_PWD='D:/Downloads/ZYBO-master/projects/DigitalAudio/I2S_Audioplayer/hardware/I2S_AudioPlayer.runs/System_Reset_ProcessingSystem_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log System_Reset_ProcessingSystem_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source System_Reset_ProcessingSystem_0.tcl
