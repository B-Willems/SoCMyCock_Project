...
HD_PWD='D:/Downloads/ZYBO-master/projects/DigitalAudio/I2S_Audioplayer/hardware/I2S_AudioPlayer.runs/System_AXIS_I2S_Transmitter_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log System_AXIS_I2S_Transmitter_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source System_AXIS_I2S_Transmitter_0_0.tcl
